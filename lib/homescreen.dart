...
void initState() {
  ...
  Future<void> _startCapture() async {
    ...
    await _audioRecorder.start(listener, onError,
        sampleRate: _sampleRate.toInt(), bufferSize: _bufferSize,androidAudioSource: ANDROID_AUDIOSRC_MIC, waitForFirstDataOnAndroid: false, firstDataTimeout: Duration(seconds: 0));

    setState(() {
        print(InstrumentType.values);
  ...
  void listener(dynamic obj) {
    ...
    if (result.pitched) {
      ...
      setState(() {
        ...
        //pitch['expectedFrequency'] = handledPitchResult.expectedFrequency.toString();
